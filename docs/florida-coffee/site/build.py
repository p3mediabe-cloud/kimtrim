...
page("/kariyer/", shell(hero("Kariyer","Barista standardı üretir.<br>Siz de üretin.","Her barista hazırladığı her fincanla markayı temsil eder. Deneyim şart değil; 45 günlük eğitimimiz var.",[("Kariyer",None)],"latteart") +
...
page("/kariyer/basvuru/", shell(hero("Kariyer · Başvuru","Dört adım, üç dakika.<br>Sonra biz sizi buluruz.","Formu bitiren adayları yapay zekâ şubelerle eşleştirir; açık vardiya doğduğunda size sorar, yanıtınızı kayda alır, müsaitseniz hemen başlarsınız.",[("Kariyer","/kariyer/"),("Başvuru",None)],"latteart") +
