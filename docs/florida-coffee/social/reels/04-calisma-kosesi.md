...
| | |
|---|---|
| **Pijler** | Kampanya / sadakat (mekan als haak) |
| **Persona** | Zeynep (21, SAÜ-studente, Sakarya) |
| **Platform** | TikTok (primair) |
| **Vestiging** | Sakarya — Çark Caddesi |
| **Duur** | 16 s |
| **Doel** | App-installaties + herhaalbezoek in de studentenmarkt |

## Concept

De enige reel in de set met TikTok-ritme: sneller, speelser, vriendin-toon. Het probleem
van Zeynep is concreet — een plek waar je úren kunt blijven. We tonen de oplossing
zonder over prijs te praten (§11.1) en hangen de loyaliteitshaak er zacht aan.

```
SLAG 1 — HAAK    0–1,5 s   Laptop dicht bij leeg stopcontact elders → snijdt naar ons stopcontact.
SLAG 2 — MOMENT  1,5–11 s  Werkhoek: laptop, notities, filterkoffie, middaglicht.
SLAG 3 — LANDING 11–16 s   Tweede kopje verschijnt. CTA app. Eindkaart.
```
...
|---|---|
| 0,5 s | `Priz var.` |
| 5,0 s | `Wi-Fi var. Acele yok.` |
| 12,0 s | `İkincisi bizden.` |

**Caption — TikTok:**
```
priz var. wi-fi var. acele yok.

finaller yaklaşıyor, köşe hazır ☕
uygulamada biriktir, bir sonraki kahven hediye

📍 sakarya çark caddesi
#floridacoffee #sakarya #çalışmakafesi #kahvekeyfi #mutluluğuntadı #üçüncüdalga #öğrenci #ders
```
...
Notların, laptopun ve saatlerin.
Köşe senin olduğu sürece kimse acele ettirmez.

Uygulamada biriktir, bir sonraki kahven bizden ☕

📍 Florida Coffee Sakarya — Çark Caddesi
#floridacoffee #mutluluğuntadı #kahvekeyfi #üçüncüdalga #sakarya #çalışmakafesi #filtrekahve
```

## Montage

```
Clips      : 01-priz.mp4 (0–2 s) · 02-kose.mp4 (2–11 s) · 03-ikinci.mp4 (11–16 s)
Tekstkaart : 0,5 s  "Priz var."              — cream op petrol, onderin
Tekstkaart : 5,0 s  "Wi-Fi var. Acele yok."
Tekstkaart : 12,0 s "İkincisi bizden."       — amber
Logo       : logo-reverse.png linksboven, vanaf 0,0 s — petrol geschilderde wand
Eindkaart  : 14,5–16 s  logo-reverse.png op #004854
Geluid     : trending sound (studie/lo-fi), knippen op de beat
Export     : 1080×1920, H.264, ±8 Mbps
```

## Aannames & te verifiëren

- **`İkincisi bizden` is een actie-uitspraak en mag pas de deur uit als HQ de voorwaarden
  van het loyaliteitsprogramma bevestigt** (§11.1). Alternatief zonder toezegging:
  `Uygulamada biriktir.`
- Wi-Fi en stopcontacten in Sakarya Çark Caddesi zijn aangenomen, niet geverifieerd.
- Vestiging Çark Caddesi staat in §2.2 als Cadde54 Florida Coffee Ltd. Şti. — laten bevestigen.
