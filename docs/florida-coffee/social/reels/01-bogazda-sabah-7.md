...
| **Persona** | Selin & Can (34–40, weekend Boğaz) — secundair Emre (ochtendritme) |
| **Platform** | Instagram Reels (primair) · TikTok (kortere montage) |
| **Vestiging** | Beykoz — Kelle İbrahim Cad. 27 |
| **Duur** | 17 s |
| **Doel** | Merkgevoel + opslaan ("hier wil ik heen dit weekend") |

## Concept

Het rustigste half uur van İstanbul, en jouw fincan staat er al. Geen product-pitch,
geen actie — puur het moment dat niemand kan kopiëren. Dit is de reel die de
positionering uit §8.2 recht doet: *de beleving verkoopt, het vakmanschap bewijst.*

```
SLAG 1 — HAAK    0–2 s    Stoom kringelt voor het water. Veerboot in de verte.
SLAG 2 — MOMENT  2–13 s   Trage push-in over de terrasreling naar de beker.
SLAG 3 — LANDING 13–17 s  Licht raakt het water, hand pakt de beker. Eindkaart.
```
...
| Tijd | Tekst |
|---|---|
| 0,6 s | `Sabah 7. Vapur geçiyor.` |
| 8,0 s | `Şehir daha uyanmadı.` |
| 14,0 s | `Kahven hazır.` |

**Caption — Reels:**
```
Sabah 7. Vapur geçiyor.

Işık suya yeni değdi.
Şehrin gürültüsü henüz başlamadı.
Bu yarım saat senin.

Bu köşe seni bekliyor ☕

📍 Florida Coffee Beykoz — Kelle İbrahim Cad. 27
#floridacoffee #mutluluğuntadı #kahvekeyfi #üçüncüdalga #boğaz #beykoz #sabahkahvesi #manzara
```

**Caption — TikTok (korter, kleine letters):**
```
sabah 7, vapur geçiyor, kahve hazır ☕
boğaz'ın en sakin yarım saati

📍 beykoz
#floridacoffee #boğaz #beykoz #sabahkahvesi #kahvekeyfi #mutluluğuntadı #üçüncüdalga #manzara
```

## Montage

```
Clips      : 01-haak.mp4 (0–2 s) · 02-moment.mp4 (2–13 s) · 03-landing.mp4 (13–17 s)
...
- Adres Beykoz komt uit analyse §2.2 en is **nog niet door de klant bevestigd**. Vóór
  publicatie laten bevestigen door HQ, of de regel `📍` inkorten tot alleen `Beykoz`.
