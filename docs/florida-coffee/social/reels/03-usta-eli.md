...
| | |
|---|---|
| **Pijler** | Barista / insan (zanaat) |
| **Persona** | Alle — dit is de vertrouwensreel |
| **Platform** | Reels + TikTok (beide monteringen) |
| **Vestiging** | Branderij / Çengelköy |
| **Duur** | 18 s |
| **Doel** | Het directe tegengif tegen §5.3: wisselende kwaliteit. Vakmanschap tónen. |

## Concept

De hele keten in één reel: groene bonen → branden → malen → shot. Geen enkele
kwaliteitsclaim in woorden; de handen doen het werk. Dit is de reel die P3Media in de
pitch gebruikt om te laten zien dat social ook een operationeel probleem kan adresseren.

```
SLAG 1 — HAAK    0–2 s    Groene bonen stromen door handen. Geluid van de trommel.
SLAG 2 — MOMENT  2–13 s   Branden → eerste crack → malen → tamper.
SLAG 3 — LANDING 13–18 s  Espresso loopt, tijgerstrepen. CTA. Eindkaart.
```
...
|---|---|---|---|---|---|
| 1 | Groene bonen glijden door een open hand | Statisch macro, ondiepe scherpte | Warm zijlicht, donkere achtergrond | 8 s | `img/branded/hasat-9x16.jpg` |
| 2 | Trommel van de brander draait, bonen tuimelen amberkleurig | Trage push-in | Amber gloed uit de trommel | 8 s | `img/branded/kavurma-9x16.jpg` |
| 3 | Espresso stroomt uit portafilter, tijgerstrepen crema | Statisch macro, zachte rack focus | Amber, petrol tegelwand | 8 s | `img/branded/pour-9x16.jpg` |
...
| Tijd | Tekst |
|---|---|
| 0,5 s | `Çekirdek bizim.` |
| 7,0 s | `Kavurma bizim.` |
| 14,0 s | `Tadı da öyle.` |

**Caption — Reels:**
```
Çekirdek bizim. Kavurma bizim.

Yeşil çekirdek elden geçer.
Trommel döner, ilk çatlak duyulur.
Sonra usta eli değer.

Fincana gidene kadar her adım bizde.

#floridacoffee #mutluluğuntadı #kahvekeyfi #üçüncüdalga #kahvekavurma #barista #espresso #çekirdek
```
...
yeşil çekirdekten fincana kadar her adım burada

#floridacoffee #kahvekavurma #barista #espresso #üçüncüdalga #kahvekeyfi #mutluluğuntadı #çekirdek
```

## Montage

```
Clips      : 01-cekirdek.mp4 (0–2 s) · 02-kavurma.mp4 (2–13 s) · 03-shot.mp4 (13–18 s)
...
- De reel toont eigen branderij en eigen inkoop. Dat volgt uit §2.1 (eigen kavurma,
  SCA-standaard). **Geen SCA-claim per vestiging** — alleen het proces tonen.
- Geen herkenbare gezichten: bewust, zowel voor toestemming (§11.3) als om
  AI-gezichtsfouten te vermijden.
