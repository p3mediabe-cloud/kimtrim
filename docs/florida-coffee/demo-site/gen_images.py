...
SHOTS = {
 ...
 "hasat":     ("16:9", "Coffee harvest on a highland farm in Ethiopia at golden hour: close on a farmer's weathered hands picking ripe red coffee cherries from a branch into a woven basket, misty green hills behind, warm amber sun, shallow focus, respectful documentary style. Strictly no cups, no mugs, no packaging, no products, no logos; only the farmer, the plants, the cherries and the basket."),
