# Florida Coffee sunumu · canlı demo akışı ve kontrol listesi

Sunum: 23 slayt (`04-sunum-deck.html`). Demo: https://p3mediabe-cloud.github.io/kimtrim/ · Uygulama: https://p3mediabe-cloud.github.io/kimtrim/app/

## Sunumdan 30 dakika önce

Bilgisayar
- Chrome veya Safari'de sekmeleri sırayla açıp bir kez sonuna kadar kaydırın (görseller önbelleğe alınır):
  1. `/` ana sayfa
  2. `/menu/`
  3. `/menu/flat-white/`
  4. `/subeler/kavacik/`
  ...
  6. `/kariyer/basvuru/`
  7. `/app/`
  8. Deste: `04-sunum-deck.html` (F tam ekran, N notlar, ← → ilerle)
- Bildirimleri kapatın (Rahatsız etmeyin). Yakınlaştırma yüzde 100.
- Telefonu ekran yansıtma ile bağlıyorsanız kabloyu deneyin; kablosuz yansıtma toplantı Wi-Fi'ında kopabilir.

Telefon
- Düşük güç modu kapalı (video otomatik oynatma için).
- Ayarlar → Erişilebilirlik → Hareket → "Hareketi azalt" kapalı (aksi hâlde video ve animasyonlar tasarım gereği durur).
- Safari'de gizli sekme kullanmayın; siteyi bir kez açıp kaydırın.
- Ekran kilidi süresi en az 5 dakika.

Yedek
- Wi-Fi yoksa telefon hotspot. Site statik, sayfa bir kez yüklendikten sonra sunucuya ihtiyaç duymaz.
- Deste tek dosyadır, çevrimdışı açılır.

## 12 dakikalık akış

| Dk | Ekran | Ne gösterilir | Cümle |
|---|---|---|---|
...
- **Fotoğraflar gerçek mi?** Marka paleti ve bardakla üretilmiş sahne seti; gerçek çekimler geldiğinde aynı yuvalara bir günde geçer (deste 9).
- **Fiyatlar doğru mu?** Örnek fiyatlardır; canlıda merkezden yönetilir, şube fiyat grubuna göre otomatik güncellenir.
- **Uygulama gerçek mi?** Tarayıcıda çalışan işlevsel prototip; akış, ekranlar ve kurallar gerçek uygulamanın şartnamesi.
- **Sadakat kartı geçişi?** Fiziksel kart QR ile uygulamaya aktarılır (sözleşme 7.4).
- **Ne kadar sürer?** Deste 21: yol haritası, 0–6 hafta lansman, 3–6 ay platform.
